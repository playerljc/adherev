...
export default {
  ...
  //     } = this;
  //
  //     $refs.el.className = `${selectorPrefix} ${className}`;
  //
  //     $refs.el.children[0].src = originSrc || placeholder;
  //
  //     this.update();
  //   },
  // },
  ...
  //
  //     img.onerror = () => {
  //       const imgEl: HTMLImageElement = el.children[0];
  //
