...
export const imageLazyProps = {
  imgArgs: object<IImgArgs>().def({
...
export default defineComponent({
  ...
  setup(props, {}) {
    ...
    //   const img = new Image();
    //
    //   const { originSrc, errorSrc, targetSrc, ...others } = toRaw(props.imgArgs);
    //
    //   const imgProps = others as any;
    //
    //   for (const p in imgProps) {
    //     if (imgProps[p].value !== undefined && imgProps[p].value !== null) {
    //       img.setAttribute(p.toLowerCase() === 'classname' ? 'class' : p, imgProps[p].value);
    //     }
    //   }
    //
    //   img.onload = () => {
    //     const parent = root.value as HTMLDivElement;
    //
    //     const imgEl = parent.children[0] as HTMLImageElement;
    //
    ...
    //
    //   img.onerror = () => {
    //     const imgEl: HTMLImageElement = (root.value as HTMLDivElement)
    ...
    //
    // watch(
    //   () => props.imgArgs.targetSrc,
    //   () => {
    //     ((root.value as HTMLDivElement).children[0] as HTMLImageElement).src =
    //       props.imgArgs.originSrc || placeholder;
    //
    //     update();
    //   },
    // );
    ...
    return () => (
      <img
        class="lazyload"
        src={props.imgArgs.originSrc || placeholder}
        data-src={props.imgArgs.targetSrc}
        alt=""
      />
    );
  },
