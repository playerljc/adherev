...
export function extend(Vue: any): void {
  ...
  Vue.config.globalProperties.$tv = function (key: string, variables?: object | null): string {
    return IntlV.v(key, variables);
  };

  Vue.config.globalProperties.$tvHtml = function (key: string, options?: object | null) {
