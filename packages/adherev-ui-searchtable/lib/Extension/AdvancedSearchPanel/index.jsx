...
export default {
    ...
    render(h) {
        const { advancedSearch: { getPopupContainer, onBeforeShow, onBeforeClose, onAfterShow, onAfterClose, ...overlayProps }, } = this.advancedSearchConfig;
        return (<Teleport to={getPopupContainer?.() || document.body}>
        <SlideLayout.Overlay {...{
            props: overlayProps,
            on: {
        ...
        }} defaultCollapse={this.collapse} class={classNames(selectorPrefix, overlayProps.className || '')}>
          <VerticalFlexLayout class={`${selectorPrefix}-inner`}>
            <header slot="renderTop" class={`${selectorPrefix}-header`}>
              ...
              <div class={`${selectorPrefix}-collapse`} onClick={() => {
              ...
              <div class={`${selectorPrefix}-main-inner`}>
                <div class={`${selectorPrefix}-scroll`}>
                  <ScrollLayout scrollY>
                    {renderGridSearchFormGroup(this.$createElement, this, this.advancedSearchConfig.showStrategy === 'all'
                ? this.groupData
                : this.remainingGroupData, this.tableGridLayoutConfig)}
                  </ScrollLayout>
                </div>
