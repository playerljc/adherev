...
export default {
    ...
    render(h) {
        return (<Popover 
        // @ts-ignore
        content={<Setting columns={this.getContext?.()?.context?.getSortColumnSetting?.() || []} onShowColumns={(checked) => {
                ...
                }}/>} placement="bottomRight" trigger="click" getPopupContainer={(el) => el.parentElement}>
        <a>
