import { Button, Checkbox, Icon, Input, InputNumber, Popover, Rate, Slider, Switch, Table, } from 'ant-design-vue';
...
import SearchTable, { NUMBER_GENERATOR_RULE_ALONE, NUMBER_GENERATOR_RULE_CONTINUITY, ROW_SELECTION_CONTINUOUS_MODE, ROW_SELECTION_NORMAL_MODE, } from './SearchTable';
...
const { _util: { withInstall, withVue }, } = BfdUtil;
