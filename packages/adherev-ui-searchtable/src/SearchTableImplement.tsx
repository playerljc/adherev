import { ColumnsType, TableRowSelection } from 'ant-design-vue/es/table/interface';
    ...
    methods: Object.assign(
      {
        ...
        getColumns(): Array<ColumnsType> {
          return [];
        },

        onSubTableChange(): void {},

        renderSearchFormAfter(): VNode | null {
          return null;
        },

        renderSearchFormBefore(): VNode | null {
          return null;
        },

        renderTableFooter(): VNode | null {
          return null;
        },

        renderTableHeader(): VNode | null {
          return null;
        },
      },
      {
