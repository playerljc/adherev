declare const _default: {
    ...
    transformTreeData(treeData: any[], onCallback: (node: any) => import("@baifendian/adhere-util/lib/types").IAntdTreeNode): import("@baifendian/adhere-util/lib/types").IAntdTreeNode[];
    getLang(): string;
