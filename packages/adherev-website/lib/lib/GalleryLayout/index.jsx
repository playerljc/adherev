...
export default {
    ...
    methods: {
        ...
        renderGallery(h) {
            ...
            do {
                ...
                result.push(<Row gutter={24}>
            {itemList.map((t, index) => (<Col span={24 / rowCount} key={`${index}`}>
    ...
    render(h) {
        ...
        <div class={styles.Fixed}>
          <Search style="width: 60%" placeholder="请输入关键字" value={this.keyword} allowClear enterButton onChange={this.onChange} onSearch={this.onSearch}/>
        </div>
