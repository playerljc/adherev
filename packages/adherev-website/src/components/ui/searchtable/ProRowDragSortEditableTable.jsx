...
const { SearchTableImplementFactory, ProDragSortEditableSearchTable, EditableTableControl } =
  SearchTable;
...
export default SearchTableImplementFactory(
  extend({
    ...
    methods: {
      getComponentId() {
        return 'ProRowDragSortEditableTable';
      },
       ...
       * @override
       */
      renderSearchFooterItems(h, defaultItems) {
