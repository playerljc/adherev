...
(ContourBlock as any)?.isUse()){ 

(ContourBlock as any)?.use(Vue); }
		if(

(DateDisplay as any)?.isUse()){ 
...
(VueQuillSandBox as any)?.isUse()){ 

(VueQuillSandBox as any)?.use(Vue); }
		if(

(WritingBoard as any)?.isUse()){ 
